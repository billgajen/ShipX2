              ...
              <div className="d-flex align-items-center justify-content-between flex-wrap">
                <div className="mb-3">
                  ...
                  <span className="d-block mb-2 fs-14">
                    <i className="fas fa-calendar me-2"></i>Ordered on Sep 8th,
                    2020
                  </span>
                  <h4 className="fs-22 font-w700 mb-0">
                    Womens Vintage Retro Bodycon Ladies
                  </h4>
                  <div class="mt-1 fs-16 font-w500 mb-2">
                    <span class="font-w600 text-primary">L003 DRESS01</span>
                    <span class=""> / B09ABC2327</span>
                  </div>
                </div>
                <div className="mb-3">
                ...
                <div className="card-body">
                  <div className="freight_tracking">
                    <div className="mb-3">
                      ...
                      <span className="d-block fs-12 font-w500">
                        Shipment has departed from a DHL facility CINCINNATI HUB
                        - USA
                      </span>
                    </div>
                    <div className="row">
            ...
            <div className="col-xl-7 col-lg-12">
              <div className="text-white bg-primary card">
                <div className="card-header justify-content-between">
                  ...
                  <button type="button" class="btn btn-dark light btn-sm">
                    Update
                  </button>
                </div>
                <div className="card-body">
