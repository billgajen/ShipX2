          ...
          <div className="profile card card-body px-3 pt-3 pb-0">
            <div className="profile-head">
              <div className="photo-content ">
                <HeaderBanner heading={supplier.name} />
              </div>
              <div className="profile-info">
                ...
                <div className="profile-details">
                  <div className="profile-name px-3 pt-2">
                    <h4 className="text-primary mb-0">{supplier.email}</h4>
                    <p>Email</p>
                  </div>
                  <div className="profile-email px-2 pt-2">
                    <h4 className="text-muted mb-0">{supplier.phoneNumber}</h4>
                    <p>Telephone</p>
                  </div>
            ...
            <div className="col-lg-12">
              <div className="card">
                <div className="card-header border-0 pb-0">
                  <h4 className="text-primary">{`${supplier.name}'s special: Hot Selling Products!!`}</h4>
                </div>
